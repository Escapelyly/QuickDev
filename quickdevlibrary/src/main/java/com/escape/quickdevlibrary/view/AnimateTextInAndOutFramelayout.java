...
public class AnimateTextInAndOutFramelayout extends FrameLayout implements
	...
	public interface OnTextClickListener {
		void onTextViewClick(TextView tv);
	}

	private OnTextClickListener mClickListener;

	public AnimateTextInAndOutFramelayout(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public AnimateTextInAndOutFramelayout(Context context) {
		super(context);
		init();
		// TODO Auto-generated constructor stub
	}
...
//				txt.setShadowLayer(2, 2, 2, 0xff696969);
				...
				txt.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						mClickListener.onTextViewClick(txt);
					}
				});
				// 获取文本长度
